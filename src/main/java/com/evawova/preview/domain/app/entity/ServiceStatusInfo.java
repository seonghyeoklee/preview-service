...
public class ServiceStatusInfo {
    ...
    public ServiceStatusInfo(Long id, AppInfo appInfo, ServiceStatus serviceStatus, String serviceStatusMessage,
            ...
            boolean emergencyNoticeActive, String maintenanceNotice, List<String> notices,
        ...
        this.faqContent = faqContent != null ? faqContent : new HashMap<>();
        this.supportedLanguages = supportedLanguages != null ? supportedLanguages : new HashSet<>();
    }
